...
void FClaireonBridge::BuildAndRunBootstrap()
{
	...
	const FString BootstrapCode = FString::Printf(TEXT(
		...
		"        import warnings\n"
		"        warnings.warn(f'time.sleep({seconds}) intercepted and skipped -- sleeping is disabled in Claireon to prevent editor hangs.', RuntimeWarning, stacklevel=2)\n"
		...
		"            _mod.__doc__ = 'Claireon tool bridge'\n"
		"        else:\n"
		"            _mod.__doc__ = f\"Claireon tool bridge ('{_ns_name}' namespace)\"\n"
		"        _mod.__all__ = []\n"
		"        _mod.__tools__ = []\n"
		...
		"            _mod.__doc__ = f\"Claireon tool bridge ('{_ns}' namespace)\"\n"
		"            _mod.__all__ = []\n"
		"            _mod.__tools__ = []\n"
